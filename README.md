...
I am a results-oriented leader with 15 years of extensive professional experience and a proven track record of hundreds successful ERP implementations. My expertise spans across various ERP brands, Odoo, SAP, Oracle and Dynamics AX, I have effectively managed projects in diverse sectors, and utilized a range of cloud platforms such as GCP, AWS, OCI, Azure, Oracle, and Odoo.sh, As a seasoned expert in DevOps, Docker, and Kubernetes, I bring a deep technical acumen to my work. I am also a Senior Python and JavaScript Developer, with 23,000 commits on GitHub reflecting my dedication to code excellence. My influence as an ERP Expert is well-recognized in the MENA region, with 100,000 views on YouTube and 30,000 followers on LinkedIn. Additionally, I possess specialized knowledge in IFRS, IPSASB, and accounting, further enhancing my ability to provide comprehensive solutions and insights.
